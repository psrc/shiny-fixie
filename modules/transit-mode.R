...
transit_mode_server <- function(id) {
  moduleServer(id, function(input, output, session){
    ...
    # Charts & Maps
    output$ntd_mode_boardings_chart <- renderEcharts4r({create_bar_chart(df = ntd_data |> 
    ...
    output$ntd_mode_hours_chart <- renderEcharts4r({create_bar_chart(df = ntd_data |> 
    ...
    output$ntd_mode_miles_chart <- renderEcharts4r({create_bar_chart(df = ntd_data |> 
    ...
    output$ntd_mode_bph_chart <- renderEcharts4r({create_bar_chart(df = ntd_data |> 
