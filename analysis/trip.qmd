...
- number of responses for `mode_other_specify`: `{r} length(unique(tables[["person"]]$mode_other_specify))`
...
## Trip Purpose
- number of responses for `dest_purpose_other`: `{r} length(unique(tables[["person"]]$dest_purpose_other))`
